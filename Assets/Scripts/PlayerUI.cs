...
public class PlayerUI : MonoBehaviour {
	...
	public TextMeshProUGUI TeleportMesh;
	[SerializeField] private float TeleportSmooth;
	[SerializeField] private float TeleportEase;
	[SerializeField] private float TeleportOld;
	...
	void Start () {
		...
		TeleportSmooth = (float)GameManager.Instance.TeleportTimer;
	...
	void Update () {
		...
		if (TeleportSmooth <= TeleportOld) {
			TeleportOld = TeleportSmooth-1;
		}
